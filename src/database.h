...
#define DATABASE_H_
	...
	*/
	...
	struct database
	{
	    /** Data of aminoacids and atoms*/
		Aminoacid ***data_aminoacids;/**< aminacids data                         	*/
		...
		int *naminoacids;  	 /**< number of amino acids for each protein.   */
	 	
		int maxatoms;			 /**< largest number of atoms.                  */
	    int minatoms; 			 /**< smallest number of atoms  				*/
	    int *natoms; 			 /**< number of atoms for each protein. 		*/
	};
